        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="heading two">
                    <h2>Welcome to Pet boarding service in Amman</h2>
                </div>
                <div class="love-your-pets">
                    <p>A cat hotel provides the best staying and boarding service in healthy and comfortable environment.
                    The beginning of my journey in creating Meow Hotel was driven by the goal of creating a place where a cat could truly feel at home—where it wouldn’t feel like anything had changed, even though it had moved to a new place. This idea, in particular, required a great deal of effort, especially since I had dreamed of something like this for a long time. I always thought that if I ever had to leave my cat somewhere, I’d want it to be a safe and comfortable place, just like home—and honestly, I couldn’t find one.

                    A lot of effort, time, and extensive expertise went into creating this place. My years of living with cats gave me the knowledge to understand their personalities and how to deal with them.

                    Today, after God’s blessings and over 10 years of living with cats, I can proudly say that the dream I once had has now become my reality. I’ve realized just how much this idea aligns with my personality as well!

                    Now, the project is three years old, and there’s so much more to come, God willing.

                    Three years of hard work and joy, of stress and happiness, of challenges and giving.
                    Three years, and every moment has been a translation of the love I have for these creatures that I can’t imagine a single day of my life without!
                    </p>
                    <!-- <ul class="list">
                        ...
                        <li><img src="assets/img/list.png" alt="list"></li>
                    </ul> -->
            ...
            <div class="col-lg-6">
                <div class="dogs-img">
                    <img src="assets/img/about-1.jpg" alt="dogs">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row mt-3">
            <div class="col-lg-6 col-md-6">
                <div class="video position-relative">
                        <figure>
                            <img src="https://via.placeholder.com/636x452" alt="img">
                        </figure>
                    </div>
            </div>
            <div class="col-lg-6 col-md-6">
