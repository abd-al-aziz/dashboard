...
<section class="gap">
    <div class="container">
        ...
        <h2>We know how much you love your pets. we love your pets too..</h2>
        </div>
        <div class="row">
            <div class="col-lg-6">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="provide">
                    ...
                    <div class="provide-img">
                        ...
                        <img src="https://via.placeholder.com/180x180" alt="provide">
...
<section>
    <div class="container">
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="looking">
                    <img src="https://via.placeholder.com/620x789" alt="looking">
                    <form>
                        <h3>Find Pets to Adopt</h3>
                        <ul>
                          <li>
                        ...
                        <span>Postcode</span>
                        <input type="text" name="Enter your Postcode" placeholder="Enter your Postcode">
                        <span>Breeds</span>
                        ...
                        <button class="button">Show 14 Pets</button>
                    </form>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="row pets-slider owl-carousel owl-theme">
                    <div class="col-lg-12 item">
                        <div class="pets">
    ...
    <div class="container">
        <div class="logodata owl-carousel owl-theme">
          <div class="partner item">
            <img alt="clients-logo" src="https://via.placeholder.com/180x114">
          </div>
          <div class="partner item">
            <img alt="clients-logo" src="https://via.placeholder.com/180x114">
          </div>
