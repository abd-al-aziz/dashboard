        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                ...
                <svg width="138" height="138" viewBox="0 0 673 673" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p>Regular grooming keeps your cat clean, healthy, and comfortable. It helps reduce shedding, prevents matting, and promotes skin health. Grooming also strengthens the bond between you and your pet while giving you a chance to check for any health issues. Services include brushing, bathing, nail trimming, and ear cleaning. Ensure your cat feels pampered and cared for! 🐾✨</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="pet-grooming">
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <svg width="138" height="138" viewBox="0 0 673 673" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p>We know that cats are curious creatures 🐈 and we deeply care about their safety in #mau hotel 🐱
                       Thats why we designed the rooms lighting to be invisible and away from their reach 🐈
                        You can absolutely be sure that your cat is in safe at our hotel.!</p>
                </div>
            </div>
            <div class="col-lg-12">
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <svg width="138" height="138" viewBox="0 0 673 673" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="#"><h4>Health Care</h4></a>
                    <p>Vaccination, dewarming, ticks and fleas treatments are extremely important for all cats specially in the first stages of thier lifes 😽, in that phase they become susceptible to many tough diseases, however, being vaccinated, protect them from further diseases may occur, as well as the ones that could be transmitted by other cats 🐱 . In MAU, we always make sure that all our board cats are vaccinated and have been taken the necessary treatments, in order to keep them all safe and protected. 😽</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="pet-grooming">
                ...
                <svg width="138" height="138" viewBox="0 0 673 673" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p>Adopting a cat means giving a loving home to a pet in need. It’s a rewarding experience that not only changes the life of a cat but also brings joy and companionship to your own. Adoption saves lives, reduces overpopulation, and connects you with a furry friend who’s ready to offer unconditional love. Choose adoption and make a difference! 🐾❤️</p>
                </div>
            </div>
            <!-- <div class="col-lg-4 col-md-6">
                <div class="pet-grooming">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="row">
                    <div class="col-6">
                        <div class="faq-img">
                            <img src="https://via.placeholder.com/224x173" alt="faq">
                            <img src="https://via.placeholder.com/224x173" alt="faq">
                            <img src="https://via.placeholder.com/224x173" alt="faq">
                        </div>
                    </div>
