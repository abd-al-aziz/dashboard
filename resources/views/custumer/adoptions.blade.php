        ...
        <div class="row">
            @foreach($adoptions as $adoption)
                <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                    <div class="card">
                        <img src="{{ asset($adoption->image) }}" class="card-img-top" alt="{{ $adoption->name }}">
                        <div class="card-body">
                            <h5 class="card-title">{{ $adoption->name }}</h5>
                            <p class="card-text">
                                <strong>Breed:</strong> {{ $adoption->breed }}<br>
                                <strong>Color:</strong> {{ $adoption->color }}<br>
                                <strong>Personality:</strong> {{ $adoption->personality }}
                            </p>
